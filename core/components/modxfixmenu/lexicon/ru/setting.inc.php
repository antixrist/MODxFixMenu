...
$_lang['area_modxfixmenu_main'] = 'Основные';
$_lang['area_modxfixmenu_pathes'] = 'Пути';

$_lang['setting_modxfixmenu.open_by_click'] = 'Открывать выпадающие меню по клику?';
...
$_lang['setting_modxfixmenu.css_classname_desc'] = 'Этот класс будет добавляться к тем пунктам меню, у которых в данный момент открыто выпадающее меню.';
